...
import { XrplTxFirestore } from '@local/common';
...
module.exports.onCreate = f.firestore.document(XrplTxFirestore.virtualPath).onCreate(async (snapshot, context) => {
...
// module.exports.onUpdate = f.firestore.document(XrplTxFirestore.virtualPath).onUpdate(async (snapshot, context) => {
//   if (await isTriggeredOnce(context.eventId)) {
//     return;
//   }
...
// module.exports.onDelete = f.firestore.document(XrplTxFirestore.virtualPath).onDelete(async (snapshot, context) => {
//   if (await isTriggeredOnce(context.eventId)) {
//     return;
//   }
